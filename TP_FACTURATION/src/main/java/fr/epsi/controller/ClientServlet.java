...
public class ClientServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		ClientEntite p=new ClientEntite();
		   ...
		   resp.sendRedirect("http://localhost:8080/TP_FACTURATION-0.0.1-SNAPSHOT/listeclient?action=listeclient"); //Permet de rediriger la page directement sur la liste des clients
	    }
