...
public class ProduitServlet extends HttpServlet{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		ProduitEntite p=new ProduitEntite();
		   ...
		   resp.sendRedirect("http://localhost:8080/TP_FACTURATION-0.0.1-SNAPSHOT/listeproduit?action=list"); //Permet de rediriger la page directement sur la liste des produits
	    }
}
